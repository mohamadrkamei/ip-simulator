...
@XmlType(name = "BranchAndFinancialInstitutionIdentification5", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "finInstnId",
    "brnchId"
})
public class BranchAndFinancialInstitutionIdentification5 {

    @XmlElement(name = "FinInstnId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", required = true)
    public FinancialInstitutionIdentification8 finInstnId;
    @XmlElement(name = "BrnchId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
