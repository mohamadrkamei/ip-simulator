...
@XmlType(name = "Party11Choice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "orgId",
    "prvtId"
})
public class Party11Choice {

    @XmlElement(name = "OrgId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public OrganisationIdentification8 orgId;
    @XmlElement(name = "PrvtId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public PersonIdentification5 prvtId;
