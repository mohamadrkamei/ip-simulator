 ...
 *       &lt;sequence>
 *         &lt;element name="CardRdngCpblties" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}CardDataReading1Code" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="CrdhldrVrfctnCpblties" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}CardholderVerificationCapability1Code" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="OnLineCpblties" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}OnLineCapability1Code" minOccurs="0"/>
 *         &lt;element name="DispCpblties" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}DisplayCapabilities1" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="PrtLineWidth" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}Max3NumericText" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PointOfInteractionCapabilities1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "cardRdngCpblties",
...
public class PointOfInteractionCapabilities1 {
    ...
    @XmlElement(name = "CardRdngCpblties", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    @XmlSchemaType(name = "string")
    public List<CardDataReading1Code> cardRdngCpblties;
    @XmlElement(name = "CrdhldrVrfctnCpblties", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    @XmlSchemaType(name = "string")
    public List<CardholderVerificationCapability1Code> crdhldrVrfctnCpblties;
    @XmlElement(name = "OnLineCpblties", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    @XmlSchemaType(name = "string")
    public OnLineCapability1Code onLineCpblties;
    @XmlElement(name = "DispCpblties", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public List<DisplayCapabilities1> dispCpblties;
    @XmlElement(name = "PrtLineWidth", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
