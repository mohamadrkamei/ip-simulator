 ...
 *       &lt;sequence>
 *         &lt;element name="Refs" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}TransactionReferences3" minOccurs="0"/>
 ...
 *         &lt;element name="BkTxCd" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}BankTransactionCodeStructure4" minOccurs="0"/>
 ...
 *         &lt;element name="RltdPties" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}TransactionParties3" minOccurs="0"/>
 *         &lt;element name="RltdAgts" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}TransactionAgents3" minOccurs="0"/>
 *         &lt;element name="Purp" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}Purpose2Choice" minOccurs="0"/>
 *         &lt;element name="RltdRmtInf" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}RemittanceLocation4" maxOccurs="10" minOccurs="0"/>
 *         &lt;element name="RmtInf" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}RemittanceInformation11" minOccurs="0"/>
 *         &lt;element name="RltdDts" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}TransactionDates2" minOccurs="0"/>
 *         &lt;element name="RltdPric" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}TransactionPrice3Choice" minOccurs="0"/>
 *         &lt;element name="RltdQties" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}TransactionQuantities2Choice" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="FinInstrmId" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}SecurityIdentification19" minOccurs="0"/>
 *         &lt;element name="Tax" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}TaxInformation3" minOccurs="0"/>
 *         &lt;element name="RtrInf" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}PaymentReturnReason2" minOccurs="0"/>
 *         &lt;element name="CorpActn" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}CorporateAction9" minOccurs="0"/>
 *         &lt;element name="SfkpgAcct" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}SecuritiesAccount19" minOccurs="0"/>
 *         &lt;element name="CshDpst" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}CashDeposit1" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="CardTx" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}CardTransaction2" minOccurs="0"/>
 *         &lt;element name="AddtlTxInf" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}Max500Text" minOccurs="0"/>
...
@XmlType(name = "EntryTransaction8", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "refs",
    "amt",
    "cdtDbtInd",
    "amtDtls",
...
public class EntryTransaction8 {
    ...
    @XmlElement(name = "Refs", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    ...
    @XmlElement(name = "BkTxCd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    ...
    @XmlElement(name = "RltdPties", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public TransactionParties3 rltdPties;
    @XmlElement(name = "RltdAgts", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public TransactionAgents3 rltdAgts;
    @XmlElement(name = "Purp", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public Purpose2Choice purp;
    @XmlElement(name = "RltdRmtInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public List<RemittanceLocation4> rltdRmtInf;
    @XmlElement(name = "RmtInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public RemittanceInformation11 rmtInf;
    @XmlElement(name = "RltdDts", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public TransactionDates2 rltdDts;
    @XmlElement(name = "RltdPric", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public TransactionPrice3Choice rltdPric;
    @XmlElement(name = "RltdQties", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public List<TransactionQuantities2Choice> rltdQties;
    @XmlElement(name = "FinInstrmId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    ...
    @XmlElement(name = "RtrInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public PaymentReturnReason2 rtrInf;
    @XmlElement(name = "CorpActn", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public CorporateAction9 corpActn;
    @XmlElement(name = "SfkpgAcct", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public SecuritiesAccount19 sfkpgAcct;
    @XmlElement(name = "CshDpst", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    ...
    @XmlElement(name = "AddtlTxInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
