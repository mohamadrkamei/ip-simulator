...
@XmlType(name = "AmountAndCurrencyExchange3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "instdAmt",
    "txAmt",
    "cntrValAmt",
    "anncdPstngAmt",
...
public class AmountAndCurrencyExchange3 {
    ...
    @XmlElement(name = "InstdAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public AmountAndCurrencyExchangeDetails3 instdAmt;
    @XmlElement(name = "TxAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public AmountAndCurrencyExchangeDetails3 txAmt;
    @XmlElement(name = "CntrValAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public AmountAndCurrencyExchangeDetails3 cntrValAmt;
    @XmlElement(name = "AnncdPstngAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public AmountAndCurrencyExchangeDetails3 anncdPstngAmt;
    @XmlElement(name = "PrtryAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
