...
@XmlType(name = "Product2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "pdctCd",
    "unitOfMeasr",
    "pdctQty",
    "unitPric",
...
public class Product2 {
    ...
    @XmlElement(name = "PdctCd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", required = true)
    public String pdctCd;
    @XmlElement(name = "UnitOfMeasr", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    @XmlSchemaType(name = "string")
    public UnitOfMeasure1Code unitOfMeasr;
    @XmlElement(name = "PdctQty", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public BigDecimal pdctQty;
    @XmlElement(name = "UnitPric", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public BigDecimal unitPric;
    @XmlElement(name = "PdctAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public BigDecimal pdctAmt;
    @XmlElement(name = "TaxTp", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public String taxTp;
    @XmlElement(name = "AddtlPdctInf", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
