...
@XmlType(name = "ClearingSystemMemberIdentification2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "clrSysId",
    "mmbId"
})
public class ClearingSystemMemberIdentification2 {

    @XmlElement(name = "ClrSysId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public ClearingSystemIdentification2Choice clrSysId;
    @XmlElement(name = "MmbId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", required = true)
    public String mmbId;
