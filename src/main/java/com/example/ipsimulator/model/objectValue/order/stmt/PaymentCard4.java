 ...
 *       &lt;sequence>
 *         &lt;element name="PlainCardData" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}PlainCardData1" minOccurs="0"/>
 *         &lt;element name="CardCtryCd" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}Exact3NumericText" minOccurs="0"/>
 *         &lt;element name="CardBrnd" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}GenericIdentification1" minOccurs="0"/>
 *         &lt;element name="AddtlCardData" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}Max70Text" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PaymentCard4", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "plainCardData",
    "cardCtryCd",
    "cardBrnd",
    "addtlCardData"
...
public class PaymentCard4 {
    ...
    @XmlElement(name = "PlainCardData", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public PlainCardData1 plainCardData;
    @XmlElement(name = "CardCtryCd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public String cardCtryCd;
    @XmlElement(name = "CardBrnd", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public GenericIdentification1 cardBrnd;
    @XmlElement(name = "AddtlCardData", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
