...
@XmlType(name = "TransactionReferences3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "msgId",
    "acctSvcrRef",
    "pmtInfId",
    "instrId",
...
public class TransactionReferences3 {
    ...
    @XmlElement(name = "InstrId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public String instrId;
    @XmlElement(name = "EndToEndId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public String endToEndId;
    @XmlElement(name = "TxId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public String txId;
    @XmlElement(name = "MndtId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public String mndtId;
    @XmlElement(name = "ChqNb", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public String chqNb;
    @XmlElement(name = "ClrSysRef", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public String clrSysRef;
    @XmlElement(name = "AcctOwnrTxId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public String acctOwnrTxId;
    @XmlElement(name = "AcctSvcrTxId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public String acctSvcrTxId;
    @XmlElement(name = "MktInfrstrctrTxId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public String mktInfrstrctrTxId;
    @XmlElement(name = "PrcgId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
