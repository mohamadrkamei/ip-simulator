 ...
 *         &lt;element name="SchmeNm" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}OrganisationIdentificationSchemeName1Choice" minOccurs="0"/>
...
@XmlType(name = "GenericOrganisationIdentification1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "id",
    "schmeNm",
    "issr"
})
