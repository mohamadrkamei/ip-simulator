...
@XmlType(name = "BankTransactionCodeStructure5", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "cd",
    "fmly"
})
public class BankTransactionCodeStructure5 {
    ...
    public String cd;
    @XmlElement(name = "Fmly", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", required = true)
