 ...
 *         &lt;element name="AdmstnZn" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}Max35Text" minOccurs="0"/>
...
@XmlType(name = "TaxInformation3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "cdtr",
    "dbtr",
    "admstnZn",
    "refNb",
...
public class TaxInformation3 {
    ...
    @XmlElement(name = "AdmstnZn", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
