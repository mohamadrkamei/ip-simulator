...
@XmlType(name = "FinancialInstitutionIdentification8", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "bicfi",
    "clrSysMmbId",
    "nm",
    "pstlAdr",
...
public class FinancialInstitutionIdentification8 {
    ...
    @XmlElement(name = "BICFI", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public String bicfi;
    @XmlElement(name = "ClrSysMmbId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
