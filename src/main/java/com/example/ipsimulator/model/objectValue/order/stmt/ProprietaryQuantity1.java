 ...
 *         &lt;element name="Qty" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}Max35Text"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ProprietaryQuantity1", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "tp",
    "qty"
})
public class ProprietaryQuantity1 {
    ...
    public String tp;
    @XmlElement(name = "Qty", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", required = true)
    public String qty;
