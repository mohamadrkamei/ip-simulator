 ...
 *         &lt;element name="FrToAmt" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}FromToAmountRange"/>
 *         &lt;element name="EQAmt" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}ImpliedCurrencyAndAmount"/>
 *         &lt;element name="NEQAmt" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}ImpliedCurrencyAndAmount"/>
 *       &lt;/choice>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ImpliedCurrencyAmountRangeChoice", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "frAmt",
    "toAmt",
    "frToAmt",
    "eqAmt",
...
public class ImpliedCurrencyAmountRangeChoice {
    ...
    @XmlElement(name = "FrAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public AmountRangeBoundary1 frAmt;
    @XmlElement(name = "ToAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public AmountRangeBoundary1 toAmt;
    @XmlElement(name = "FrToAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public FromToAmountRange frToAmt;
    @XmlElement(name = "EQAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public BigDecimal eqAmt;
    @XmlElement(name = "NEQAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public BigDecimal neqAmt;
