...
@XmlType(name = "Price2", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "tp",
    "val"
})
public class Price2 {
    ...
    @XmlElement(name = "Val", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", required = true)
