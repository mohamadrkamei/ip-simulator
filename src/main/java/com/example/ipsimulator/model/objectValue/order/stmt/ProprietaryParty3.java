 ...
 *         &lt;element name="Pty" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}PartyIdentification43"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ProprietaryParty3", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "tp",
    "pty"
})
public class ProprietaryParty3 {
    ...
    public String tp;
    @XmlElement(name = "Pty", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", required = true)
