...
@XmlType(name = "DateAndPlaceOfBirth", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "birthDt",
    "prvcOfBirth",
    "cityOfBirth",
    "ctryOfBirth"
...
public class DateAndPlaceOfBirth {
    ...
    @XmlElement(name = "BirthDt", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", required = true)
    public String birthDt;
    @XmlElement(name = "PrvcOfBirth", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public String prvcOfBirth;
    @XmlElement(name = "CityOfBirth", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", required = true)
    public String cityOfBirth;
    @XmlElement(name = "CtryOfBirth", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", required = true)
