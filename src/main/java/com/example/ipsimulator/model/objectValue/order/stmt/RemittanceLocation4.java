...
@XmlType(name = "RemittanceLocation4", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "rmtId",
    "rmtLctnDtls"
})
public class RemittanceLocation4 {

    @XmlElement(name = "RmtId", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
    public String rmtId;
    @XmlElement(name = "RmtLctnDtls", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06")
