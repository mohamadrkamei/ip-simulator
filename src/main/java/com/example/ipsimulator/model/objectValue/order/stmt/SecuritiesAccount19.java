 ...
 *         &lt;element name="Tp" type="{urn:iso:std:iso:20022:tech:xsd:camt.053.001.06}GenericIdentification30" minOccurs="0"/>
...
@XmlType(name = "SecuritiesAccount19", namespace = "urn:iso:std:iso:20022:tech:xsd:camt.053.001.06", propOrder = {
    "id",
    "tp",
    "nm"
})
